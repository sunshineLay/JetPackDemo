...
//    }
    ...
    public static void setImageViewPlace(ImageView view, String url, @DrawableRes int placeholder){
    ...
    public static void setImageViewPlace(ImageView view, String url){
        if(TextUtils.isEmpty(url)){
            view.setImageResource(R.drawable.zore);
        }else{
            Glide.with(view.getContext()).load(url).into(view);
        }
    }
